...
#PlotA
plot(housepower$datetime, housepower$Voltage, type="l", xlab="datetime", ylab="Voltage", col="black")
...
#plotB
plot(housepower$datetime, housepower$Global_reactive_power, type="l", col="black", xlab="datetime", ylab="Global_reactive_power")
